        ...
        <div class="col-md-8">
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('weather/search') ?>" method="post" class="weather-search-form">
                        <div class="input-group">
                            <input type="text" name="city" class="form-control" placeholder="Enter city name (e.g., London, New York, Paris)" required>
