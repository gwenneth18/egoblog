...
<p>
	We received a request to reset password for egblog account associated <i><?= $mail_data['user']->email ?></i>.
    TO reset your password use the button below:
	<br><br>
	...
	<br><br>
	<b>NB:</b> This link will remain active for 15 minutes.
	<br><br>
	This email can be safely disregarded if you did not request a password reset.
